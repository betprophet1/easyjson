...
```sh
# for Go < 1.17
go get -u github.com/betprophet1/easyjson/...
```
#### or
```sh
# for Go >= 1.17
go get github.com/betprophet1/easyjson && go install github.com/betprophet1/easyjson/...@latest
```
### Run:
```sh
...
Please see the [GoDoc](https://godoc.org/github.com/betprophet1/easyjson)
...
listing](https://godoc.org/github.com/betprophet1/easyjson) for the full listing of
...
Please see the [GoDoc listing](https://godoc.org/github.com/betprophet1/easyjson/buffer)
